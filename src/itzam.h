...
/* comment out the following to enable threading with shared memory
 */
#define ITZAM_SHMEM_ENABLE 1
...
static const char * ITZAM_DISPLAY_VERSION = "7.0.0 beta"; 
...
itzam_bool itzam_btree_find_before(itzam_btree * btree, const void * search_key, void * result);

itzam_bool itzam_btree_find_after(itzam_btree * btree, const void * search_key, void * result);
...
itzam_state itzam_btree_cursor_create_at(itzam_btree_cursor * cursor, itzam_btree * btree, const void * start_key, itzam_bool before);
